...
namespace AppRequisitos.ViewModels
{
    public partial class InventarioVM : ObservableObject
    {
        ...
        public InventarioVM(CumplimientoDbContext context)
        {
        ...
        private async Task ObtenerCategorias()
        {
            ...
            await Task.Run(async () =>
            {
                ...
                var categoriaDefault = new CategoriaDTO { IdCategoria = 0, Nombre = "Todas las Actividades" };
        ...
        {
            await Shell.Current.Navigation.PushModalAsync(new ProductoPage(new ProductoVM(new DataAccess.CumplimientoDbContext()), 0));
        }
        ...
        {
            await Shell.Current.Navigation.PushModalAsync(new ProductoPage(new ProductoVM(new DataAccess.CumplimientoDbContext()), producto.IdProducto));
        }
